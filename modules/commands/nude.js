...
"https://i.imgur.com/QYGOZuK.jpg",
  ...
  var money = data.money
      if(money < 1000) api.sendMessage("Bạn cần 0 đô để xem ảnh ?",event.threadID,event.messageID)
          else {
   Currencies.setData(event.senderID, options = {money: money - 1000})
   var callback = () => api.sendMessage({body:`Cạn lời :))\n-0 đô`,attachment: fs.createReadStream(__dirname + "/cache/nude.jpg")}, event.threadID, () => fs.unlinkSync(__dirname + "/cache/nude.jpg")); 
