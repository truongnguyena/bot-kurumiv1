...
module.exports.handleEvent = async function ({
    ...
    const modDev = config.DeveloperMode
     if ((this.config.credits) != "kurumi") { return }
...
module.exports.run = async ({
    ...
    if ((this.config.credits) != "kurumi") { return api.sendMessage(`cre`, event.threadID, event.messageID)}
    const {
        configPath
    } = global.client;
    const {
